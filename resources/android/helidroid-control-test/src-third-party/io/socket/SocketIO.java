...
public class SocketIO {
	 ...
	 * calling {@link #connect(java.net.URL, io.socket.IOCallback)} or
	 * {@link #connect(String, io.socket.IOCallback)}
	 */
	public SocketIO() {
	...
	/**
	 * Instantiates a new socket.io connection. The object connects after
	 * calling {@link #connect(io.socket.IOCallback)}
	 * 
	 * @param url
	 *            the url
	 ...
	 * after calling {@link #connect(io.socket.IOCallback)}
	 * 
	 * @param url
	 *            the url
	 * @param headers
	 *            the {@link java.util.Properties headers} used while handshaking
	 * @throws java.net.MalformedURLException
	 *             the malformed url exception
	 */
