...
public abstract class WebSocketServer extends WebSocketAdapter implements Runnable {
	 ...
	 * listeners for WebSocket connection requests. Creates a fixed thread pool with the size {@link org.java_websocket.server.WebSocketServer#DECODERS}<br>
	 * May only be called once.
	 * 
	 * Alternatively you can call {@link org.java_websocket.server.WebSocketServer#run()} directly.
	 * 
