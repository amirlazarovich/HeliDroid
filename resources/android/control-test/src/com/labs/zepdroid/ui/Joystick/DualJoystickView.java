...
public class DualJoystickView extends LinearLayout {
    ...
    // TODO tasks:
    // 1. need to change the listener to DualJoystickMoveListener, in order to distinguish between joysticks in one callback method
    // 2. need to add a safety mechanism on the arduino that detects USB disconnects and slowly lowers down the motors speed until they stop
    // 3. start logging device orientation using the gyro
