...
class EventHandler(tornadio2.SocketConnection):
	...
	def emit_all(self, event, type, val1, val2, val3, val4):
		print "[{event}] {type}:: val1: {val1}, val2: {val2}, val3: {val3}, val4: {val4}".format(event=event, type=type, val1=val1, val2=val2, val3=val3, val4=val4)
		for connection in connections:
			print "connection: %s" % connection
			connection.emit(event, type, val1, val2, val3, val4)
